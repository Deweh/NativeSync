...
namespace RE
{
	...
	public:
		...
		//Flag should be 0x35
		void PlayIdle(Actor* a, int a_action, TESIdleForm* idle, bool a_checkConditions = true, RE::TESObjectREFR* a_targetObj = nullptr)
		{
			using func_t = decltype(&AIProcess::PlayIdle);
			REL::Relocation<func_t> func{ REL::ID(1446774) };
			return func(this, a, a_action, idle, a_checkConditions, a_targetObj);
		}
	...
	public:
		...
		bool GetRequiresIdleStop()
		{
			using func_t = decltype(&Actor::GetRequiresIdleStop);
			REL::Relocation<func_t> func{ REL::ID(567828) };
			return func(this);
		}
